...
public class RoomRepositoryIT {
  ...
  @Test
  public void saveNewRoom_withDuplicateName_throwException() {
    final Room room = new Room(null, "COKE_R01", Companies.COKE,null);

    assertThatThrownBy(() -> roomRepository.save(room))
        .isInstanceOf(DataIntegrityViolationException.class);
  }

  @ParameterizedTest
  @MethodSource("invalidName")
  public void saveNewRoom_withInvalidName_throwException(Room room) {
  ...
  @Test
  public void saveNewRoom_withNullCompany_throwException() {
  ...
  @Test
  public void saveNewRoom_ok() {
    final Room room = new Room(null, "room name", Companies.COKE,null);

    assertThat(roomRepository.save(room).getId()).isNotNull();
  }


  private void assertConstraintViolationExceptionOnSaveRoom(Room room,
